...
/* Mock client resolved from a scanned code */
const MOCK_CLIENT = {
    code: "TRB-2504-041",
    name: "Terrou-Bi",
    ...
    return (
        <View style={styles.root}>
            ...
            <View style={styles.frameArea}>
                ...
                {!scanned && (
                    <Pressable onPress={handleManualSimulate} hitSlop={8}>
            ...
            >
                <View
                    style={[styles.handle, { backgroundColor: colors.ink200 }]}
                />
                ...
                {scanned ? (
                    <>
                        ...
                        <View style={styles.sheetTop}>
                            <View style={{ flex: 1 }}>
                                <Text
                                    style={[styles.sheetCaps, { color: colors.ok700 }]}
                                >
                                    ✓ Hôtel identifié
                                </Text>
                                <Text
                        ...
                        <View style={styles.tilesRow}>
                            ...
                            >
                                <Text
                                    style={[styles.tileCaps, { color: colors.ink500 }]}
                                >
                                    Nb pièces
                                </Text>
                                <Text
                        ...
                        <View style={styles.miniRow}>
                            ...
                            >
                                <Icon name="signature" size={15} color={colors.ink600} />
                                <View style={{ flex: 1 }}>
                                    <Text
                                        style={[styles.miniTitle, { color: colors.ink900 }]}
                                    >
                    ...
                    <>
                        <Text style={[styles.hintTitle, { color: colors.ink900 }]}>
                            Positionnez le QR dans le cadre
                        </Text>
